      ...
      child: SizedBox(
        ...
        child: BlocBuilder<TrackCollectionBloc, TrackCollectionState>(
            ...
            builder: (context, buildState) {
              var categories = buildState.getCategories();
              if (categoriesNames.isEmpty ||
                  categoriesNames.length != categories.names.length) {
                categoriesNames = [];
              ...
              isSelected = List.generate(
                  categoriesNames.length, (i) => i == 0 ? true : false);
              print(isSelected);
              print(categoriesNames);
              return Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: categoriesNames.isEmpty
                    ? []
